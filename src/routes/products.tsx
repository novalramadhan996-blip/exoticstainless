...
const TITLE = "Produk Stainless Steel Custom | Exotic Stainless";
const DESCRIPTION =
  "Produk stainless steel custom Exotic Stainless untuk pagar, railing, pintu, peralatan dapur, fasilitas kesehatan, laboratorium, dan kebutuhan proyek di Jabodetabek.";
...
export const Route = createFileRoute("/products")({
  head: () => ({
    meta: [
      ...
      { property: "og:image:alt", content: "Produk stainless steel hasil fabrikasi Exotic Stainless" },
